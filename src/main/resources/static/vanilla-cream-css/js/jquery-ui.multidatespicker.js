  ...
  $.fn.multiDatesPicker = function (method) {
    ...
    function addDate(date, type, no_sort) {
      ...
      if (methods.gotDate.call(this, date, type) === false) {
        ...
        if (!no_sort) {
          this.multiDatesPicker.dates[type].sort(
              methods.compareDates);
        }
      }
    }
    ...
    var methods = {
      init: function (options) {
        ...
        var mdp_events = {
          ...
          onSelect: function (dateText, inst) {
            ...
            if (this.multiDatesPicker.mode == 'normal'
                ...
                do {
                  ...
                  for (var i = 0; i < disabled.length; i++) {
                    if (disabled[i].getTime() <= max_date.getTime()) {
                      if ((min_date.getTime() <= disabled[i].getTime())
              ...
              if (this.multiDatesPicker.maxDate && (max_date
            ...
            if ($this.datepicker('option', 'altField') != undefined
          ...
          beforeShowDay: function (date) {
            var $this = $(this),
                ...
                isDisabledDate = $this.multiDatesPicker('gotDate', date,
                    'disabled') !== false,
                areAllSelected = this.multiDatesPicker.maxPicks
                    == this.multiDatesPicker.dates.picked.length;

            var custom = [true, ''];
            if (this.multiDatesPicker.originalBeforeShowDay) {
              custom = this.multiDatesPicker.originalBeforeShowDay.call(this,
                  date);
            }

            var highlight_class = gotThisDate ? 'ui-state-highlight'
                : custom[1];
            var selectable_date = !(isDisabledCalendar || isDisabledDate
          ...
          onClose: function (dateText, inst) {
            ...
            if (this.multiDatesPicker.originalOnClose) {
              this.multiDatesPicker.originalOnClose.call(
                  this, dateText, inst);
            }
          }
        };
        ...
        if (options) {
          ...
          this.multiDatesPicker.minDate = $.datepicker._determineDate(this,
              options.minDate, null);
          this.multiDatesPicker.maxDate = $.datepicker._determineDate(this,
      ...
      dateConvert: function (date, desired_format, dateFormat) {
        ...
        switch (from_format) {
          ...
          case 'number':
            ...
            break;
          default:
            $.error('Conversion from "' + desired_format
        ...
        switch (desired_format) {
          ...
          case 'number':
            return date.getTime();
          default:
            $.error('Conversion to "' + desired_format
                + '" format not allowed on jQuery.multiDatesPicker');
        }
        return false;
      },
      gotDate: function (date, type) {
        ...
        for (var i = 0; i < this.multiDatesPicker.dates[type].length; i++) {
          if (methods.compareDates.call(this,
              this.multiDatesPicker.dates[type][i], date) === 0) {
            return i;
          }
        }
        return false;
        ...
        if (dates.length > 0) {
          ...
          switch (typeof dates) {
            ...
            case 'number':
              ...
              break;
            default:
              $.error('Date format "' + typeof dates
    ...
    this.each(function () {
      ...
      if (methods[method]) {
        var exec_result = methods[method].apply(this,
